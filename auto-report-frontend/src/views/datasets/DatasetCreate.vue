  ...
  <div class="dataset-create">
    <div class="page-header">
      <div class="header-content">
        ...
        <p class="page-description">创建新的数据分析数据集，配置数据源和字段映射</p>
      </div>
    </div>
    ...
    <el-card class="form-card">
      ...
      <el-form ref="formRef" :model="formData" :rules="formRules" label-width="120px">
        <el-row :gutter="24">
          ...
          <el-col :span="12">
            <el-form-item label="数据集类型" prop="type">
              <el-select v-model="formData.type" placeholder="请选择数据集类型" style="width: 100%">
        ...
        <el-form-item label="文件上传" v-if="formData.type === 'file'">
          <el-upload
            class="file-upload"
            drag
            action="#"
